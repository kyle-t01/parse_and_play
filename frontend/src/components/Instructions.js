    ...
    return (
        <div className="instructions">
            ...
            <ul>
                ...
                <li>duration (optional): use : to specify duration (for example: C:1/4 specifies quarter note, default duration is 1/4 if omitted)</li>
                <li>No Note: . to specify no note to be played (for example: .: or just .) </li>
                <li>Octave (optional, range = [1,6]): specify octave a note that will be played in, default is 4 (for example: C4, default octave is 4 if omitted) </li>
            </ul>
